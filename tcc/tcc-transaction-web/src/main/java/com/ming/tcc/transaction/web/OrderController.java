...
public class OrderController {
    ...
    public ModelAndView productDetail(@PathVariable long userId,
        ...
        mv.addObject("capitalAmount", placeOrderService.getCapitalAccountByUserId(userId));
        mv.addObject("redPacketAmount", placeOrderService.getRedPacketAccountByUserId(userId));
    ...
    public ModelAndView placeOrder(@RequestParam String redPacketPayAmount,
        ...
        String status = placeOrderService.getOrderStatusByMerchantOrderNo(merchantOrderNo);
        ...
        mv.addObject("capitalAmount", placeOrderService.getCapitalAccountByUserId(payerUserId));
        mv.addObject("redPacketAmount", placeOrderService.getRedPacketAccountByUserId(payerUserId));
