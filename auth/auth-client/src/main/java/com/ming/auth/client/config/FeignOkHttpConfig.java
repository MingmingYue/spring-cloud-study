package com.ming.auth.client.config;

import com.ming.auth.client.interceptor.OkHttpTokenInterceptor;
import feign.Feign;
...
public class FeignOkHttpConfig {
    ...
    @Autowired
    FeignOkHttpConfig(OkHttpTokenInterceptor okHttpLoggingInterceptor) {
